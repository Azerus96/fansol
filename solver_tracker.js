    ...
    function renderHUD() {
        ...
        hud.innerHTML = `
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;border-bottom:1px solid rgba(255,255,255,0.1);padding-bottom:6px;">
                <strong style="color:#60a5fa;font-size:13px;">🏎️ OFC Fantasy Solver</strong>
                <span id="ofc-status" style="font-size:10px;background:#f39c12;padding:2px 6px;border-radius:10px;">Ожидание карт...</span>
            </div>
